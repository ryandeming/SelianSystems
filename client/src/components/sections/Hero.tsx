    ...
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 grid md:grid-cols-2 gap-12 items-center">
        <div className="max-w-2xl">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-black text-white leading-[1.1] mb-6 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
            CUT THE BS. <br />
          ...
          <p className="text-lg md:text-xl text-white/80 mb-8 max-w-lg leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
            No agency fluff. No spreadsheets. Just simple marketing and CRM tools that help contractors build, track, and convert leads into cash.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 mb-12 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-300">
            <Button size="lg" className="bg-primary hover:bg-primary/90 text-background font-bold text-lg h-14 px-8 rounded-full shadow-[0_0_20px_-5px_rgba(255,145,77,0.5)]">
              Book a Demo
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button size="lg" variant="outline" className="border-white/20 text-white hover:bg-white/10 h-14 px-8 rounded-full">
              See How It Works
            </Button>
          </div>
